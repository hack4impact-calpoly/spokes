...
export default function EventConfirmationModal({ isOpen, onClose }: EventConfirmationModalProps) {
      ...
      <Modal isOpen={isOpen} onClose={onClose} isCentered>
        ...
        >
          ...
          <ModalBody className="self-stretch text-gray-600 text-sm sm:text-base font-normal leading-normal">
            Your event has been submitted for review. Upon approval, your event will be published to the Spokes event
