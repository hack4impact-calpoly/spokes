  ...
  return (
    <div className="w-full h-full">
      ...
      <div className="mt-20 px-8 md:px-16 lg:px-20 flex flex-col lg:flex-row gap-16 lg:gap-8">
        <div>
          <div className="text-black font-semibold text-3xl mb-2 lg:mb-6">Filters</div>
          <div>
        ...
        <div className="w-full">
          <div className="flex gap-8 w-full">
            <div
              className={twMerge(
                "text-black text-3xl mb-2 lg:mb-6 cursor-pointer",
            ...
            <div
              className={twMerge(
                "text-black text-3xl mb-6 cursor-pointer",
